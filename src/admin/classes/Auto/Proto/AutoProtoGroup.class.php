...
/* $Id$ */
	...
	abstract class AutoProtoGroup extends AbstractProtoClass
	{
		...
		{
			return array(
				'id' => LightMetaProperty::fill(new LightMetaProperty(), 'id', null, 'integerIdentifier', 'Group', 4, true, true, false, null, null),
				'parent' => LightMetaProperty::fill(new LightMetaProperty(), 'parent', 'parent_id', 'identifier', 'Group', 4, false, false, false, 1, 3),
