	...
	abstract class AutoProtoProperty extends AbstractProtoClass
	{
		protected function makePropertyList()
		{
			return array(
				...
				'isRequired' => LightMetaProperty::fill(new LightMetaProperty(), 'isRequired', 'is_required', 'boolean', null, null, true, true, false, null, null),
				'isShow' => LightMetaProperty::fill(new LightMetaProperty(), 'isShow', 'is_show', 'boolean', null, null, true, true, false, null, null),
				...
				'isParent' => LightMetaProperty::fill(new LightMetaProperty(), 'isParent', 'is_parent', 'boolean', null, null, true, true, false, null, null)
			);
		}
	}
?>